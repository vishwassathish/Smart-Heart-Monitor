...
#define SSID "Mark"     // "SSID-WiFiname" 
#define PASS "mark13579"       // "password"
#define IP "184.106.153.149"// thingspeak.com ip
String msg = "GET /update?key=X5RU7EOW612PVA7R"; //change it with your api key like "GET /update?key=Your Api Key"
...
{
  lcd.begin(16, 2);
  lcd.print("Welcome to Heart-0Beat Detector");
  delay(100);
  lcd.setCursor(0,1);
